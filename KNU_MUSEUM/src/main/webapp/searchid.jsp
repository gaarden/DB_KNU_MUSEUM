...
<body>
	...
	try {
		...
		String query = "SELECT UserID FROM USERS WHERE Name ='" + request.getParameter("name") + "' AND Email = '"
		+ request.getParameter("email") + "' AND PNumber = '" + request.getParameter("phoneNumber") + "'";
