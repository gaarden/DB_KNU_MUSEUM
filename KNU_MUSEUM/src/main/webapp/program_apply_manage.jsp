	...
	<div class="table-responsive">
			...
			<table class="table align-middle">
				...
				while (rs.next()) {
					...
					String applyDateStr = rs.getString(5);
					...
					out.println("<td>" + (rs.getString(6) != null ? rs.getString(6) : "") + "시</td>");
					out.println("<td>" + (rs.getString(7) != null ? rs.getString(7) : "") + "명</td>");
					out.println("<td>" + (rs.getString(8) != null ? rs.getString(8) : "") + "</td>");
					out.println("<td><button onclick='location.href=\"program_apply_o.jsp?ApplyID=" + rs.getString(1)
							+ "\"'>승인</button></td>");
					out.println("<td><button onclick='location.href=\"program_apply_x.jsp?ApplyID=" + rs.getString(1)
							+ "\"'>반려</button></td>");
					out.println("</tr>");
						}
			...
			<table class="table align-middle">
				...
				while (rs2.next()) {
					...
					out.println("<td>" + (rs2.getString(6) != null ? rs2.getString(6) : "") + "시</td>");
					out.println("<td>" + (rs2.getString(7) != null ? rs2.getString(7) : "") + "명</td>");
					out.println("<td>" + (rs2.getString(8) != null ? rs2.getString(8) : "") + "</td>");

					if (rs2.getString(9).equals("1")) {
						out.println("<td>승인</td>");
					} else if (rs2.getString(9).equals("0")) {
						out.println("<td>반려</td>");
					} else if (rs2.getString(9).equals("2")) {
